...
test-shlib: test.cpp $(TARGET_LIB)
...
test-statlib: test.cpp libzxcvbn.a
	$(CC) $(CPPFLAGS) $(CFLAGS) -o $@ $^ $(LDFLAGS) -lm

libzxcvbn.a: zxcvbn-inline.o
	$(AR) cvr $@ $^

test-file: test.cpp zxcvbn-file.o
	$(CC) $(CPPFLAGS) $(CFLAGS) \
		-DUSE_DICT_FILE -o test-file test.cpp zxcvbn-file.o $(LDFLAGS) -lm

zxcvbn-file.o: zxcvbn.cpp dict-crc.h zxcvbn.h
	$(CC) $(CPPFLAGS) $(CFLAGS) \
		-DUSE_DICT_FILE -c -o zxcvbn-file.o zxcvbn.cpp

test-inline: test.cpp zxcvbn-inline.o
	$(CC) $(CPPFLAGS) $(CFLAGS) \
		-o test-inline test.cpp zxcvbn-inline.o $(LDFLAGS) -lm

test-internals: test-internals.cpp zxcvbn.cpp dict-src.h dict-crc.h zxcvbn.h
	$(CC) $(CPPFLAGS) $(CFLAGS) \
		-o test-internals test-internals.cpp $(LDFLAGS) -lm

zxcvbn-inline-pic.o: zxcvbn.cpp dict-src.h zxcvbn.h
	$(CC) $(CPPFLAGS) $(CFLAGS) -fPIC -c -o $@ $<

zxcvbn-inline.o: zxcvbn.cpp dict-src.h zxcvbn.h
	$(CC) $(CPPFLAGS) $(CFLAGS) -c -o zxcvbn-inline.o zxcvbn.cpp
...
test-c++inline: test.cpp zxcvbn-c++inline.o
	if [ ! -e test.cpp ]; then ln -s test.cpp test.cpp; fi
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) \
		-o test-c++inline test.cpp zxcvbn-c++inline.o $(LDFLAGS) -lm

zxcvbn-c++inline.o: zxcvbn.cpp dict-src.h zxcvbn.h
	if [ ! -e zxcvbn.cpp ]; then ln -s zxcvbn.cpp zxcvbn.cpp; fi
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) \
		-c -o zxcvbn-c++inline.o zxcvbn.cpp

test-c++file: test.cpp zxcvbn-c++file.o
	if [ ! -e test.cpp ]; then ln -s test.cpp test.cpp; fi
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) \
		-DUSE_DICT_FILE -o test-c++file test.cpp zxcvbn-c++file.o $(LDFLAGS) -lm

zxcvbn-c++file.o: zxcvbn.cpp dict-crc.h zxcvbn.h zxcvbn-c++inline.o
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) \
